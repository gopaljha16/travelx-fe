...
function EmployeeManagementContent() {
  ...
  const handleAddEmployee = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewEmployee({ email: "", name: "", role: "employee", password: "" });
      fetchData();
    } catch (err: any) {
                        ...
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                               ...
                               <p className="text-[10px] uppercase font-black tracking-tighter text-on-surface-variant/60">ID: {emp.user_id.slice(-6)}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-8 py-6">
                ...
                {successInfo ? (
                  ...
                  <form onSubmit={handleAddEmployee} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <label className="block text-[11px] font-bold uppercase tracking-wider text-on-surface-variant ml-1">Full Name (Optional)</label>
                        <div className="relative">
                        ...
                        <p className="text-[10px] text-on-surface-variant ml-1 italic">Required if creating a new account.</p>
                      </div>
